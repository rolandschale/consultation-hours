 ...
 */
class OpeningHoursListingModulesController extends
    AbstractFrontendModuleController
{
    ...
    public function __invoke(
        ...
        if (
            ...
            $scopeMatcher->isFrontendRequest($request)
        ) {
            // If TL_MODE === 'FE'
    ...
    protected function getResponse(
        ...
        if (!empty($arrGuests)) {
            $template->helloText =
                "Our guests today are: " . implode(", ", $arrGuests);
        }
