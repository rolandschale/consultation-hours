 ...
 * Content element
 */
$GLOBALS['TL_LANG']['CTE']['image_elements'] = 'Inhaltselement-Kategorie-Übersetzung';
$GLOBALS['TL_LANG']['CTE'][HeroimageElementController::TYPE] = ['Inhaltselement-Typ-Übersetzung', 'Beschreibung'];
